...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'admin@topjek.my.id';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'admin@topjek.my.id';
   ...
   * @var string
   */
  public $Sender            = 'admin@topjek.my.id';
  ...
  */
   ...
   * @var string
   */
  public $Username      = 'admin@topjek.my.id';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'kacinong95#@!';
