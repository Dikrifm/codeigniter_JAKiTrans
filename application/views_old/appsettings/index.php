                                ...
                                <div class="col-12 grid-margin">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="appcurrency">Geo Api Key</label>
                                                <input type="password" class="form-control" id="mapkey" name="map_key" value="<?= $appsettings['map_key']; ?>" required></div>
                                                
                                             <div class="form-group">
                                                <label for="appcurrency">Fcm Api Key</label>
                                                <input type="password" class="form-control" id="fcmkey" name="fcm_key" value="<?= $appsettings['fcm_key']; ?>" required></div>
                                           <div class="form-group">
                                                <label for="appcurrency">Main Color Background :</label></br>
                                                 <input type="color" id="head" name="main_background" value="<?= $appsettings['main_background']; ?>" required></div>
