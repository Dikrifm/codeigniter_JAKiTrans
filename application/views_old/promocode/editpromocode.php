        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="birthdate">Point</label>
                        <input type="text" class="form-control" id="point" name="point" placeholder="enter point value" value="<?= $promo['point'] ?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="js-example-basic-single" onchange="admSelectCheck(this);"  name="type_promo" style="width:100%" >
                            ...
                            <option id="point" value="point" <?php if ($promo['type_promo']== 'point') { ?>selected<?php } ?>>Point</option>
                        </select>
                    </div>
    ...
    function admSelectCheck(nameSelect) {
        ...
        if (nameSelect) {
            ...
            if (serviceValue == nameSelect.value) {
                ...
                document.getElementById("pointcheckrequired").required = false;
                ...
                document.getElementById("pointcheck").style.display = "none";
            } else if (pointValue == nameSelect.value) {
                document.getElementById("fixcheckrequired").required = false;
                document.getElementById("persencheckrequired").required = false;
                document.getElementById("pointcheckrequired").required = true;
                document.getElementById("fixcheck").style.display = "none";
                document.getElementById("persencheck").style.display = "none";
                document.getElementById("pointcheck").style.display = "block";
            }
        } else {
            document.getElementById("persencheck").style.display = "block";
        }
